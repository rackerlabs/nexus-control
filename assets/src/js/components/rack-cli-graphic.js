...
module.exports = angular.module('drc.components.rack-cli-graphic', [])
.directive('rackCliGraphic', [function () {
  return {
    restrict: 'A',
    link: function ($scope, $element, $attrs) {
      ...
      var render = function () {
        requestAnimationFrame(function () {
          var parentScaleFactor = staticImage.width / staticImage.naturalWidth;
          ...
          animatedImage.style.left = ((210 - staticImage.offsetLeft)/625 * 100) + '%';
          animatedImage.style.top = '25.75%';
          animatedImage.style.width = (animatedImage.naturalWidth * baseScaleFactor * parentScaleFactor) + 'px';
